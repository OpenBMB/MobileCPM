...
@objc public protocol WaterfallMutiSectionDelegate: NSObjectProtocol {
    // 必选delegate实现
    /// collectionItem高度
...
@objc public class WaterfallMutiSectionFlowLayout: UICollectionViewFlowLayout {
    @objc weak var delegate: WaterfallMutiSectionDelegate?
    ...
    public override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        // todo: @sgl
        let cellHeight: CGFloat = (self.delegate?.heightForRowAtIndexPath(collectionView: self.collectionView!, layout: self, indexPath: indexPath, itemWidth: cellWeight)) ?? 0
